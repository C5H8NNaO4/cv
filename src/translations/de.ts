...
const translation = {
  translation: {
    ...
    eMail: 'E-Mail',
    German: 'Deutsch',
    'German (C2)': 'Deutsch (C2)',
    'English (C1)': 'Englisch (C1)',
    'Spanish (B2)': 'Spanisch (B2)',
    English: 'Englisch',
    Spanish: 'Spanisch',
    ...
    'descriptions.react-server': (
      await import('@/data/descriptions/react-server/de.md?raw')
    ).default,
    'descriptions.lists': (await import('@/data/descriptions/lists/de.md?raw'))
      .default,
